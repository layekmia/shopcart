            ...
            <div className="bg-shop_light_bg p-5">
              <div className="text-xs flex items-center gap-5">
                <div className="flex items-center relative group cursor-pointer">
                  ...
                  <span className="absolute w-full -bottom-1.5 bg-lightColor/30 inline-block h-0.5 group-hover:bg-shop_dark_green cursor-pointer hoverEffect left-0 " />
                </div>
