...
export default function HomeBanner() {
  return (
    ...
    //     <Link href='/shop' className="bg-shop_dark_green/90 text-white/90 text-sm px-5 py-2 rounded-md font-semibold hover:text-white hover:bg-shop_dark_green hoverEffect">Buy Now</Link>
    //   </div>
    //   <div>
    //     <Image alt="banner image" src={banner_1} className="hidden md:inline-flex w-96" />
    //   </div>
    // </div>
